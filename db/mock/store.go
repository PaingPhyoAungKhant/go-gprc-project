...
// Source: go-gprc-project/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) ListTransfers(ctx context.Context, offset int32) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfers", ctx, offset)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListTransfers(ctx, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfers", reflect.TypeOf((*MockStore)(nil).ListTransfers), ctx, offset)
}
